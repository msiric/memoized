...
export const SECTION_ICONS = {
  builtInDataStructuresIcon: (
    <MdDataObject size={60} className="fill-indigo-500" />
  ),
  userDefinedDataStructuresIcon: (
    <MdOutlineAccountTree size={60} className="fill-indigo-500" />
  ),
  commonTechniquesIcon: (
    <MdStackedBarChart size={60} className="fill-indigo-500" />
  ),
  advancedTopicsIcon: <PiPathBold size={60} className="fill-indigo-500" />,
