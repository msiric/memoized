...
export const CORE_FUNDAMENTALS_PROBLEMS = {
...
export const TYPESCRIPT_INTRODUCTION_PROBLEMS = {
  advancedTypes: [
    {
      href: '',
...
export const ADVANCED_CONCEPTS_PROBLEMS = {
  designPatterns: [
    {
      href: '',
...
export const FRONTEND_DEVELOPMENT_PROBLEMS = {
  accessibility: [
    {
      href: '',
...
export const ALL_PROBLEMS = [
  ...
  ...Object.values(CORE_FUNDAMENTALS_PROBLEMS).flatMap((lesson) =>
    lesson.map((item) => item.href),
  ),
  ...Object.values(TYPESCRIPT_INTRODUCTION_PROBLEMS).flatMap((lesson) =>
    lesson.map((item) => item.href),
  ),
  ...Object.values(ADVANCED_CONCEPTS_PROBLEMS).flatMap((lesson) =>
    lesson.map((item) => item.href),
  ),
  ...Object.values(FRONTEND_DEVELOPMENT_PROBLEMS).flatMap((lesson) =>
    lesson.map((item) => item.href),
  ),
]
