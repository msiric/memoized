...
export const metadata: Metadata = {
  ...
  description: `Get premium access to ${CONTENT_STATS.problems} JavaScript interview problems, detailed solutions, and exclusive content. Advanced algorithms, system design, and JavaScript-specific patterns. Student discounts available.`,
  keywords: [
  ...
  openGraph: {
    title: 'Premium Access - Unlock Advanced JavaScript Interview Prep',
    description: `Get premium access to ${CONTENT_STATS.problems} JavaScript interview problems with detailed solutions and exclusive content.`,
  ...
  twitter: {
    ...
    title: 'Premium Access - Unlock Advanced JavaScript Interview Prep',
    description: `Get premium access to ${CONTENT_STATS.problems} JavaScript interview problems with detailed solutions.`,
