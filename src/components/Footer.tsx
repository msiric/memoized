...
function SmallPrint() {
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-200 pt-8 sm:flex-row dark:border-white/5">
      <div>
        <p className="text-center text-xs text-zinc-600 sm:text-left dark:text-zinc-400 p-2">
          Contact:{' '}
          <a
      ...
      <div className="flex flex-col">
        <div className="flex justify-center gap-4">
          <span className="p-2">
            <SocialLink href="https://x.com/oiramciris" icon={XIcon}>
              Follow on X
            </SocialLink>
          </span>
          <span className="p-2">
...
export type FooterWidth = 'full' | 'wide' | 'prose'
...
export function Footer({ fullWidth, width }: FooterProps) {
  // Support legacy fullWidth prop, default to 'full'
  const resolvedWidth = width ?? (fullWidth === false ? 'prose' : 'full')
