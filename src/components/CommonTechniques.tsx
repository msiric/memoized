...
export const commonTechniques: LessonConfig[] = [
  ...
  {
    id: '/two-pointers',
    href: `${COURSE_PREFIX}/two-pointers`,
    title: 'Two Pointers',
  ...
  },
  {
    ...
    href: `${COURSE_PREFIX}/fast-and-slow-pointers`,
  ...
  {
    id: '/merge-intervals',
    href: `${COURSE_PREFIX}/merge-intervals`,
  ...
  {
    id: '/cyclic-sort',
    href: `${COURSE_PREFIX}/cyclic-sort`,
    title: 'Cyclic Sort',
  ...
  },
  {
    ...
    href: `${COURSE_PREFIX}/linked-list-reversal`,
  ...
  {
    id: '/binary-search',
    href: `${COURSE_PREFIX}/binary-search`,
    title: 'Binary Search',
  ...
  {
    id: '/top-k-elements',
    href: `${COURSE_PREFIX}/top-k-elements`,
  ...
  {
    id: '/k-way-merge',
    href: `${COURSE_PREFIX}/k-way-merge`,
    title: 'K-way Merge',
  ...
  {
    id: '/topological-sort',
    href: `${COURSE_PREFIX}/topological-sort`,
  ...
  {
    id: '/matrix-traversal',
    href: `${COURSE_PREFIX}/matrix-traversal`,
  ...
  },
  {
    ...
    href: `${COURSE_PREFIX}/palindromic-subsequence`,
  ...
  },
  {
    ...
    href: `${COURSE_PREFIX}/longest-common-substring`,
  ...
  },
  {
    ...
    href: `${COURSE_PREFIX}/recursion-and-memoization`,
  ...
  {
    id: '/backtracking',
    href: `${COURSE_PREFIX}/backtracking`,
    title: 'Backtracking',
    description:
  ...
  },
  {
    ...
    href: `${COURSE_PREFIX}/greedy-algorithms`,
