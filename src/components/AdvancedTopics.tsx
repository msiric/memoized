...
export const advancedTopics: LessonConfig[] = [
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/dynamic-programming`,
  ...
  {
    id: '/bloom-filters',
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/bloom-filters`,
    title: 'Bloom Filters',
    description:
  ...
  {
    id: '/segment-trees',
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/segment-trees`,
    title: 'Segment Trees',
  ...
  {
    id: '/union-find',
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/union-find`,
    title: 'Union Find',
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/minimum-spanning-trees`,
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/shortest-path-algorithms`,
  ...
  {
    id: '/maximum-flow',
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/maximum-flow`,
    title: 'Maximum Flow',
  ...
  {
    id: '/bit-manipulation',
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/bit-manipulation`,
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/randomized-algorithms`,
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/suffix-arrays-and-suffix-trees`,
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/approximation-algorithms`,
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/sqrt-decomposition`,
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/network-flow-algorithms`,
  ...
  {
    id: '/convex-hull',
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/convex-hull`,
    title: 'Convex Hull',
    description:
  ...
  },
  {
    ...
    href: `${COURSES_PREFIX}${DATA_STRUCTURES_AND_ALGORITHMS_PREFIX}${ADVANCED_TOPICS_PREFIX}/combinatorial-optimization`,
