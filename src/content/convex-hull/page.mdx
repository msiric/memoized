...
1. [Convex Hull Algorithm](https://www.geeksforgeeks.org/convex-hull-set-1-introduction/)
2. [Graham Scan Algorithm](https://www.geeksforgeeks.org/graham-scan-algorithm-for-convex-hull/)
3. [Jarvis March Algorithm](https://www.geeksforgeeks.org/jarvis-march-algorithm-or-wrapping/)
4. [Convex Hull using Divide and Conquer](https://www.geeksforgeeks.org/convex-hull-using-divide-and-conquer-algorithm/)
5. [Quickhull Algorithm for Convex Hull](https://www.geeksforgeeks.org/quickhull-algorithm-convex-hull/)