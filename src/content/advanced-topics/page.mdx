export const metadata = {
  title: 'Introduction to Advanced Topics in JavaScript',
  description: 'Dive into sophisticated algorithms and data structures crucial for tackling complex challenges in technical interviews and real-world applications.',
}
