...
1. [Sqrt Decomposition for Range Sum Queries](https://www.geeksforgeeks.org/sqrt-square-root-decomposition-technique-set-1-introduction/)
2. [Mo’s Algorithm for Query Problems](https://www.geeksforgeeks.org/mos-algorithm-query-square-root-decomposition-set-1-introduction/)
3. [Range Minimum Query using Sqrt Decomposition](https://www.geeksforgeeks.org/range-minimum-query-square-root-decomposition/)
4. [Sqrt Decomposition for Finding the Sum of Range with Updates](https://www.geeksforgeeks.org/sqrt-decomposition-1/)
5. [Number of Multiples in a Range](https://www.geeksforgeeks.org/number-of-multiples-in-a-given-range/)