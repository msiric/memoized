...
### **2.2 Resolving and Rejecting Promises**
...
### **6.2 Handle Errors Appropriately**
...
### **6.3 Use `Promise.allSettled()` for Independent Promises**
...
### **6.4 Avoid the Promise Constructor Anti-Pattern**
...
### **6.5 Use Async/Await for Simplicity**
