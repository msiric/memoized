...
1. [Minimum Vertex Cover](https://leetcode.com/problems/minimum-vertex-cover/)
2. [Approximate Traveling Salesman Problem](https://www.geeksforgeeks.org/travelling-salesman-problem-using-branch-and-bound/)
3. [Vertex Cover Problem](https://www.geeksforgeeks.org/vertex-cover-problem-set-2-approximate-algorithm/)
4. [Approximate Algorithms for NP-Hard Problems](https://www.geeksforgeeks.org/approximate-algorithms/)
5. [Approximation Algorithms for Facility Location Problem](https://www.geeksforgeeks.org/facility-location-problem-set-1-introduction-and-approximate-algorithms/)