...
```
Initial Pointers: slow -> 1, fast -> 1
Iteration 1: slow -> 2, fast -> 3
Iteration 2: slow -> 3, fast -> 5 (end of list)
Middle Element: 3 (slow pointer)
```
...
function detectCycle(head: ListNode | null): ListNode | null {
    ...
    while (fast !== null && fast.next !== null) {
        ...
        if (slow === fast) {
            ...
            let pointer2: ListNode | null = slow;
