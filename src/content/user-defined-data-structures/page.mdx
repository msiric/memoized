export const metadata = {
  title: 'Introduction to User-Defined Data Structures in JavaScript',
  description: 'Learn to create, manipulate, and optimize custom data structures like linked lists, stacks, queues, heaps, trees, graphs, and tries for specific problem scenarios.',
}
