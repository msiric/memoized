export const metadata = {
  title: 'Comprehensive Guide to Minimum Spanning Trees in JavaScript',
  description: 'Find the subset of edges that connects all vertices with the minimal total weight. Understand minimum spanning trees, performance considerations, and practical examples.',
}
...
1. [Kruskal’s Algorithm for MST](https://www.geeksforgeeks.org/kruskals-minimum-spanning-tree-algorithm-greedy-algo-2/)
2. [Prim’s Algorithm for MST](https://www.geeksforgeeks.org/prims-minimum-spanning-tree-mst-greedy-algo-5/)
...
5. [Minimum Cost to Connect Sticks](https://leetcode.com/problems/minimum-cost-to-connect-sticks/)