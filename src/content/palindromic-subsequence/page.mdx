export const metadata = {
  title: 'Comprehensive Guide to Palindromic Subsequence in JavaScript',
  description: 'Identify palindromic subsequences within strings. Understand palindromic subsequence algorithms, performance considerations, and practical examples.',
}
...
4. [Unique Length-3 Palindromic Subsequences](https://leetcode.com/problems/unique-length-3-palindromic-subsequences/)
5. [Maximum Product of the Length of Two Palindromic Subsequences](https://leetcode.com/problems/maximum-product-of-the-length-of-two-palindromic-subsequences/)