export const metadata = {
  title:
    'Comprehensive Guide to JavaScript and TypeScript Binary Search Tree Implementation',
  description:
    'Learn about Binary Search Trees (BST), a fundamental data structure, and understand their implementation in JavaScript and TypeScript.',
}
