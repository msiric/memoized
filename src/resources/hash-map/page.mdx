export const metadata = {
  title:
    'Comprehensive Guide to JavaScript and TypeScript Hash Map Implementation',
  description:
    'Learn about Hash Maps, a fundamental data structure, and understand their implementation in JavaScript and TypeScript.',
}
