export const metadata = {
  title:
    'Comprehensive Guide to JavaScript and TypeScript Queue Implementation',
  description:
    'Learn about Queues, a fundamental data structure, and understand their implementation in JavaScript and TypeScript.',
}
