export const metadata = {
  title:
    'Comprehensive Guide to JavaScript and TypeScript Directed Graph Implementation',
  description:
    'Learn about Directed Graphs, a fundamental graph structure, and understand their implementation in JavaScript and TypeScript.',
}
